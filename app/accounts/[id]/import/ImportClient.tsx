...
import { ArrowLeftIcon, CheckCircle2Icon, FileUpIcon } from 'lucide-react'
...
export function ImportClient({ accountId }: { accountId: string }) {
    ...
    <div className="px-6 py-10 lg:px-10">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-semibold tracking-tight">Importer un relevé</h1>
